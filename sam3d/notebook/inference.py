...
# Point CUDA_HOME at the conda env only when it actually ships a CUDA
# toolkit — unconditionally overriding it breaks JIT builds (e.g. gsplat)
# on machines where the toolkit lives elsewhere.
if "CONDA_PREFIX" in os.environ and os.path.exists(
